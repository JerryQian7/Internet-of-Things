...
void loop() {
    ...
    String jLoad = "{\"cmd\": \"LOGMC\", \"devmac\":\"CC:50:E3:AF:E1:B4\", \"temp\":\"" + String(sensor1Data.temperature,2) + "\", \"hum\":\"" + String(sensor1Data.humidity,1) + "\"}";
    //String jLoad = "{\"cmd\": \"LOGMC\", \"devmac\":\"3C:71:BF:6F:13:B8\", \"temp\" :\"" + String(sensor1Data.temperature,2) + "\", \"hum\":\"" + String(sensor1Data.humidity,1) + "\"}";
